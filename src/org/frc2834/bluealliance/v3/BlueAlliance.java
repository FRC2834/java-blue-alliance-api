...
import org.frc2834.bluealliance.v3.event.SimpleEvent;
import org.frc2834.bluealliance.v3.matches.Match;
import org.frc2834.bluealliance.v3.teams.Team;
import org.frc2834.bluealliance.v3.util.Constants;
...
public class BlueAlliance {
    ...
    private Reader createReader(String url) throws IOException {
        ...
        urlConnection.addRequestProperty("X-TBA-App-Id", "frc2834:java-blue-alliance-api:v3.0.2");
    ...
    private String createURL(String append) {
        return Constants.BLUE_ALLIANCE_BASE_URL_V3 + append;
    }
